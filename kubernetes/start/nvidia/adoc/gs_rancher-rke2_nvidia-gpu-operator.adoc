...
[source, console, subs="attributes+"]
----
zypper install ./nvidia-driver-local-repo-sles15-560.35.03-1.0-1.x86_64.rpm
----
//
+
[NOTE]
====
You may get an error about the Gpg Key not being available (e.g. Signature verification failed [4-Signatures public key is not available]). You can safely ignore this error.
====
+
