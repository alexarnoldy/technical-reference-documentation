...
After completing this procedure, remove the `{nvidia-variables-file}` and the /tmp/Dockerfile.orig files from the build host and any Kubernetes worker nodes. 
