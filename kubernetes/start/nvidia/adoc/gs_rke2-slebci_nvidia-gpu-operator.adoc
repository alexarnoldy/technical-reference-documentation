...
:sles-version: 15
:sles-sp: 5
:sles-kernel-version: 5.14.21-150500.55.65.1
...
. On your build node, make sure you have sourced your `/tmp/build-variables.sh` file to set your environment variables.
//
+
...
Using {rancher-full} to manage your {rke2} cluster allows you to more easily manage the cluster, including running commands on it without having to  download the kubeconfig file for the cluster or installing extra software on an external workstation.
