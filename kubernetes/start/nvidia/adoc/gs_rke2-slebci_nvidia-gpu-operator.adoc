...
[source, console, subs="attributes+"]
----
CUDA_VERSION="" # Insert the CUDA version, as show on driver webpage
...
[console, subs="attributes+"]
----
if grep -q 'grep "Basesystem"' "$file"; then   echo "The change has already been made.";   else   sed -i 's/\(grep \$version_without_flavor \)/\1| grep "Basesystem" /' "$file";   echo "The change has been applied."; fi
----
+
