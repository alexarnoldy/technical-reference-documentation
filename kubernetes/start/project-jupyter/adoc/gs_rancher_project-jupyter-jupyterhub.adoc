...
Create an {rke2} cluster IAW {harvester-create-rke2-cluster-url}

[NOTE]
====
In creating the {rke2} cluster, we have used these parameters:
...
[TIP]
====
This `User Data` can also be configured as a Cloud Config Template in the {harvester} UI. 
See the link:{harevester-cloud-configuration-url}[{harvester} documentation] for more information.
====
