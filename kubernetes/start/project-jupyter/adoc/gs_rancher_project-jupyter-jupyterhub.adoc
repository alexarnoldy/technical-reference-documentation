...
This requirement can be differed if there is an external load balancer available (e.g. a public cloud application load balancer).
+
...
If you want to, you can pull the border between the {rancher-kubectl-shell} and the {rancher} UI down until you need the shell again.
