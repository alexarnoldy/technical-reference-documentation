...
:scomp1: SUSE component 1 - short name
:scomp1-full: SUSE component 1 - long name
:scomp1-version: SUSE component 1 - relevant versions
:scomp1-website: SUSE component 1 - product website URL
:scomp1-docs: SUSE component 1 - product documentation URL
