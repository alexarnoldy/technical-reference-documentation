...
//+
You can easily obtain a domain name from most public DNS providers, for a small fee. You will need this for Let's Encrypt to verify your ownership of the {juypterhub} service and provide the required TLS certificates for HTTPS communication. See this link:https://community.letsencrypt.org/t/dns-providers-who-easily-integrate-with-lets-encrypt-dns-validation/86438[blog post] for a general list of DNS providers.
